    ...
    <div className="flex flex-col gap-8">
      <section>
        <p className="font-mono text-xs uppercase tracking-wider text-accent">
          Senior backend · learn + drill
        </p>
        <h1 className="mt-1 text-3xl md:text-4xl font-bold tracking-tight">
          Every topic. Concept → code → interview.
        </h1>
        <p className="text-muted mt-2 max-w-2xl">
          Read the concept, see how and when to use it with real code, then drill it with checklists and timed mock
          interviews. {perTopic.length} topics · fully offline.
        </p>
      ...
      <section>
        ...
        <TopicIndex tiers={usedTiers} topics={perTopic} />
      </section>
    </div>
  );
}
